...
glm::vec3 transitionColor = { 0.0f, 0.0f, 0.0f };
float* colorArray[3] = { &transitionColor.x, &transitionColor.y, &transitionColor.z };
...
int main() {
	...
	GLuint transition1 = ew::loadTexture("assets/gradient1.png");
	GLuint transition2 = ew::loadTexture("assets/gradient2.png");
	GLuint transition3 = ew::loadTexture("assets/gradient3.png");
	GLuint transitions[3] = { transition1, transition2, transition3 };
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glBindTextureUnit(4, transitions[selectedTransition]);
		...
		display_shader.setInt("_TransitionGradient", 4);
		display_shader.setFloat("_TransitionAmount", transitionAmount);
		display_shader.setVec3("_TransitionColor", transitionColor);
...
void drawUI() {
	...
	ImGui::SliderFloat("Transition Amount", &transitionAmount, 0.0f, 1.0f);
	if (ImGui::Button("Transition 1"))
		selectedTransition = 0;
	if (ImGui::Button("Transition 2"))
		selectedTransition = 1;
	if (ImGui::Button("Transition 3"))
		selectedTransition = 2;
	ImGui::ColorEdit3("Transition Color", *colorArray);
